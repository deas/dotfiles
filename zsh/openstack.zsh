...
_openstack()
{
  ...
  # Command data:
  cmds='access address aggregate application availability bgp bgpvpn catalog command complete compute configuration consistency console consumer container credential domain ec2 endpoint extension federation firewall flavor floating group help host hypervisor identity image implied ip keypair limit limits mapping module network object policy port project quota region registered request role router security server service sfc subnet token trust usage user versions volume vpn'
  cmds_access='token'
  ...
  cmds_bgpvpn_router_association='create delete list show'
  cmds_bgpvpn_router_association_create='-h --help -f --format -c --column --noindent --variable --prefix --max-width --fit-width --print-empty --project --project-domain'
  ...
  cmds_network='agent auto create delete flavor list log loggable meter qos rbac segment service set show subport trunk unset'
