...
let-env PROMPT_MULTILINE_INDICATOR = (^/snap/starship/2049/bin/starship prompt --continuation)
...
let-env PROMPT_COMMAND = {
    ...
    ^/snap/starship/2049/bin/starship prompt $"--cmd-duration=($env.CMD_DURATION_MS)" $"--status=($env.LAST_EXIT_CODE)" $"--terminal-width=($width)"
}
